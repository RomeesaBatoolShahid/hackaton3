...
<div className="flex-1 space-y-4">
  ...
  <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
    <div className="flex items-center mb-4 sm:mb-0">
      <img src="/smallpic (3).png" alt="Product 1" className="w-[124px] h-[124px] object-cover mr-4" />
      <div>
  ...
  <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
    <div className="flex items-center mb-4 sm:mb-0">
      <img src="/smallpic (2).png" alt="Product 2" className="w-[124px] h-[124px] object-cover mr-4" />
      <div>
  ...
  <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
    <div className="flex items-center mb-4 sm:mb-0">
      <img src="/smallpic (1).png" alt="Product 3" className="w-[124px] h-[124px] object-cover mr-4" />
      <div>
